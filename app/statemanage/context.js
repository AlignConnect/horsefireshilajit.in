...
export const GlobalContextProvider = ({ children }) => {
    ...
    useMemo(() => {
        return setCheckoutDetail({ ...checkoutDetail, checkoutUrl: checkoutDetail.checkoutChecked ? 'https://arayurveda.shop/products/ar-ayurveda-shilajit-resin-himalayan-origin-pure-20g' : "/checkout" })
